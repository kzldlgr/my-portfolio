      ...
      <div className="container mx-auto mt-8">
        <div className='flex flex-col lg:flex-row'>
          ...
          <motion.form
            ...
            <input className='bg-transparent border-b py-3 outline-none w-full placeholder:text-background focus:border-accent transition-all' name="from_name" type="text" required placeholder='Your name' />
            <input className='bg-transparent border-b py-3 outline-none w-full placeholder:text-background focus:border-accent transition-all' name="from_email" type="text" required placeholder='Your email' />
            <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-background focus:border-accent transition-all resize-none mb-12' name="message" required placeholder='Your message'></textarea>
