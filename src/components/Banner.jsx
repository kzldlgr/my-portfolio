  ...
  return (
    <section className="min-h-[100vh] flex items-center" id="home">
      <video
        ...
        loop
        muted
        className="absolute z-10 lg:min-w-full lg:min-h-full blur-lg mb-[135px]"
      >
        <source
          src={bgvideo}
          type="video/mp4"
        ...
        <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-4'>
          ...
          <div className='flex-2 text-center font-secondary lg:text-left'>
            <motion.h1
              ...
              whileInView={'show'}
              viewport={{ once: false, amount: 0.7 }}
              className='text-4xl font-bold m-2 text-white'>Hi, I am </motion.h1>
            <motion.h1
              variants={fadeIn('up', 0.3)}
              initial='hidden'
              whileInView={'show'}
            ...
            <motion.p
              ...
              whileInView={'show'}
              viewport={{ once: false, amount: 0.7 }}
              className='mb-8 max-w-xl mx-auto lg:mx-0 text-2xl text-white'>
